...
namespace CDev\XPaymentsConnector\Model\ResourceModel\PaymentConfiguration\Grid;

use CDev\XPaymentsConnector\Controller\RegistryConstants;
use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use CDev\XPaymentsConnector\Model\ResourceModel\PaymentConfiguration\Collection as PaymentConfigurationCollection;

/**
 * Collection for displaying Payment Configuration grid
 */
class Collection extends PaymentConfigurationCollection implements SearchResultInterface
{
    /**
     * Core registry
     */
